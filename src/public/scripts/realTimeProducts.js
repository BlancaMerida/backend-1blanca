...
document.addEventListener('DOMContentLoaded', () => {
    ...
    formAgregarProducto.addEventListener('submit', (e) => {
        ...
        if ( !product.title || isNaN(product.price) || isNaN(product.stock) || !product.category) {
    ...
    if (productList) {
        productList.addEventListener('click', (e) => {
            ...
            if (e.target.classList.contains('add-cart-btn')) {
                let cart = "66f86a2bd0ec1a88d8358f17";
    ...
    formModificarProducto.addEventListener('submit', (e) => {
        ...
        if ( !updatedProduct.title || isNaN(updatedProduct.price) || isNaN(updatedProduct.stock) || !updatedProduct.category) {
            alert('Todos los campos son obligatorios y deben ser válidos.');
            return;
        }
